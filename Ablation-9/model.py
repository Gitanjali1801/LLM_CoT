...
class Classifier(pl.LightningModule):
  ...
  def forward(self, x, y, e, r, c):
      ...
      output = torch.log_softmax(emf, dim=1)
      #print("output shape", output.shape)
      return output,emf,emf,emf
...
ckpt_path = 'checkpoints/epoch26-val_f1_all_mis0.84.ckpt' # put ckpt_path according to the path output in the previous cell
