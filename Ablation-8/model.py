...
class Classifier(pl.LightningModule):
  ...
  def forward(self, x, y, e, r, c):
      ...
      output = torch.log_softmax(timr, dim=1)
      #print("output shape", output.shape)
      return output,emf,timr,timr
  ...
  def training_step(self, train_batch, batch_idx):
      ...
      loss3 = self.contrastive_loss(emf,timr)
...
ckpt_path = 'checkpoints/epoch42-val_f1_all_mis0.84.ckpt' # put ckpt_path according to the path output in the previous cell
